...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "join_none large let liblist library local localparam logic longint macromodule matches medium modport pprule " +
  ...
  */
  ...
  var blockKeywords = words(
    "case checker class clocking config function generate interface pprule package" +
