...
public class FeeAndRefundDataImport extends AbstractDataImport {
    ...
    public void resolve(Workbook wb) throws Exception {
        logger.info("FeeAndRefundfile start import!");
        ...
        try {
            ...
            logger.info("FeeAndRefundfile import error!");
            e.printStackTrace();
        }
        logger.info("FeeAndRefundfile import end,size:"+feeAndRefundEntitys.size());
...
//        this.feeAndRefundDao.deleteFeeAndRefundByBatchDate(batchDate);
        ...
        try {
            ...
            logger.error("feeAndRefundfile import updateDB error!");
            e.printStackTrace();
        }finally {
            feeAndRefundEntitys.clear();
        }
