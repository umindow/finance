...
CREATE TABLE `bank_credit_info` (
  ...
  `bank_id` varchar(40) NOT NULL COMMENT '银行编号',
  `main_bank_id` varchar(40) NOT NULL COMMENT '主办行编码',
  `credit_type_id` varchar(40) NOT NULL COMMENT '授信类型：1 综合授信 2 单笔单议',
